...
function beginWork(current, workInProgress, renderLanes) {
  ...
  // console.log(workInProgress,'start-----------start-------------')
  // function fiberLoop(fiber){
  //   const list = [];
  //   if(fiber.sibling) list.unshift(fiber.sibling)
  //   if(fiber.children) list.unshift(fiber.children)
  //   while(list.length){
  //     var obj = list.shift();
  //     console.log(obj.type,obj.memoizedProps)
  //     if(obj.sibling) list.unshift(obj.sibling)
  //     if(obj.children) list.unshift(obj.children)
  //   }
  // }
  // fiberLoop(workInProgress)
  // console.log('end-----------end-------------')
...
function completeWork(current, workInProgress, renderLanes) {
  var newProps = workInProgress.pendingProps;
  console.log(workInProgress,'completeWork')
  switch (workInProgress.tag) {
    case IndeterminateComponent:
    case LazyComponent:
    case SimpleMemoComponent:
